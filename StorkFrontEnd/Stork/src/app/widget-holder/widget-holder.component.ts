...
@Component({
	...
	entryComponents: [
		...
		ResizableGraphComponent,
		WidgetCompetitorComponent
	],
...
export class WidgetHolderComponent implements OnInit {
	...
	constructor(private widgetControl: WidgetControlService, private componentfactoryResolver: ComponentFactoryResolver){
		...
		//this.widgetControl.createTestStocks(6);
		...
		this.widgetChoiceMap.push({id: 9, name: 'Resizable Graph Widget'});
		this.widgetChoiceMap.push({id : 10, name: 'Competitor Widget'});
...
//add your widgets here. return the Type identified by the import at the top
	getWidget(i: number): any{
		...
		if(i == 9) {
			return ResizableGraphComponent;
		}
		if (i == 10){
			return WidgetCompetitorComponent;
		}
	}
